      ...
      <div>
        ...
        <div className="pt-3">
          <div className="mt-3 flex justify-between gap-5">
            <div className=" text mb-10 w-1/2 rounded-md border border-gray-600 p-1 dark:border-gray-200">
          ...
          <div className="-my-6 flex justify-between gap-5">
            <div className="text mt-2 mb-10 w-1/2 rounded-md border border-gray-600 p-1 dark:border-gray-200">
