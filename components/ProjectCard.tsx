...
export function ProjectCard({ project }: ProjectCardProps) {
  let { title, description, imgSrc, href, github } = project

  return (
    <div>
      <div className="h-full overflow-hidden border-2 rounded-lg dark:border-gray-800   dark:bg-gray-900/40 hover:border-black dark:hover:border-white">
        <Image
          alt={title}
          src={imgSrc}
        ...
        <div className="p-6">
          <div className="flex justify-between mb-3">
            <h2 className="m-0 w-full  pt-2 text-xl font-bold tracking-tight ">
              {href ? (
          ...
          {href ? (
            <Link
              href={href}
              className="link-underline1  text-base  leading-6 text-primary-500 hover:text-primary-600 dark:hover:text-primary-400"
...
export function ProjectCard01({ project }: ProjectCardProps) {
  ...
  return (
    <div className="flex flex-col space-y-8 rounded-lg border  bg-gray-50/10 p-4 dark:border-gray-800 dark:bg-gray-900/40  md:flex-row md:space-y-0 md:space-x-8">
      <div className="overflow-hidden  md:w-52">
        <div className="relative h-36 w-full  md:h-full md:w-52">
          <Image
            alt={title}
            src={imgSrc}
