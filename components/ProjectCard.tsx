...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div>
      <div className=" h-full overflow-hidden border-2 rounded-lg dark:border-gray-800 bg-white dark:bg-bg  md:hover:border-black md:dark:hover:border-white shadow-lg">
        <Image
          alt={title}
          src={imgSrc}
