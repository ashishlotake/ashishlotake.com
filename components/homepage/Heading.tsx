    ...
    <>
      <section id="intro" className="flex items-center justify-center flex-col pt-5 pb-6">
        <div className="text-center">
          <h1 className="text-5xl md:text-7xl dark:text-white mb-1 md:mb-3 font-bold">
            {siteMetadata.author}
          </h1>
          <TypedBios />
          <p className="text-xl md:text-2xl pt-4 mb-2 font-bold">
            DA, DS, ML &amp; AI practitioner{' '}
          </p>
          <p className="text max-w-2xl  font-medium">
            ...
            and check out my{' '}
            <Link
              href="http://ashishlotake.com/static/resume.pdf"
