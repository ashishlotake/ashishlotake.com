            ...
            <Link key={slug} href={`/blog/${slug}`} aria-label={`Read "${title}"`}>
              <div className="group relative block h-full md:hover:scale[102%]  shadow-lg rounded-lg">
                <div className="relative  flex h-full ">
                  <div className="p-4 flex flex-1  flex-col  rounded-lg overflow-hidden border-2   dark:border-gray-800 dark:bg-bg bg-white md:hover:border-black md:dark:hover:border-white">
