    ...
    <div className="md:flex justify-between items-center pt-6 pb-6 text-sm text-gray-700 dark:text-gray-300">
      ...
      <div className="flex items-center">
        <TwitterShareButton url={postUrl} title={title} via={siteMetadata.socialAccounts.twitter}>
          <span class="mr-2 inline-flex items-center rounded border-2 border-[#55acee] bg-[#55acee] px-1 py-1 md:px-3 md:py-2 text-sm font-extrabold text-white transition-colors hover:bg-transparent hover:text-[#55acee] focus:outline-none focus:ring active:opacity-75">
            Tweet
            <svg class="ml-1 h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <Link
          ...
          class="inline-flex font-extrabold items-center rounded border-2 border-[#0077b5] bg-[#0077b5] px-1 py-1 md:px-3 md:py-2 text-sm  text-white transition-colors hover:bg-transparent hover:text-[#0077b5] focus:outline-none focus:ring active:opacity-75"
          target="_blank"
          rel="noreferrer"
        >
          Post
