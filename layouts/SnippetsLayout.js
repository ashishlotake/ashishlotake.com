          ...
          {displayPosts.map((frontMatter) => {
            ...
            return (
              <Link key={slug} href={`/snippets/${slug}`}>
                <div className="flex h-full w-full rounded-lg  border border-2 border-gray-200 transition-transform duration-300   hover:border-primary-500 dark:border-gray-700 dark:hover:border-primary-500">
                  <div className="flex flex-shrink-0 items-center  border-r border-gray-200  px-3 dark:border-gray-700 ">
                    <img
                      alt="moto"
